...
if(isset($_POST['update_teacher'])) {
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], $dst)) {
        ...
        $sql = "UPDATE teacher SET name='$t_name', description='$t_description', image='$dst_db' WHERE id='$id'";
        $result = mysqli_query($connection, $sql);
        if ($result) {
            ...
            $_SESSION['message'] = 'Error updating teacher: ' . mysqli_error($connection);
            header("Location: view_teacher.php");
            exit();
        }
    } else {
            ...
            <div class="div_deg">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <label></label>
                        <center>
                            <input class="btn btn-primary" type="submit" id="submit" name="update_teacher" value="Update">
                        </center>
                    </div>
                </form>
            </div>
